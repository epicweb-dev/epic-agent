/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./types/worker-configuration.d.ts --env production` (hash: 5a7d5cdb73cc482102795d79d8198d28)
// Runtime types generated with workerd@1.20260212.0 2026-01-31 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("../worker/index");
		durableNamespaces: "MCP" | "ChatAgent";
	}
	interface Env {
		OAUTH_KV: KVNamespace;
		APP_DB: D1Database;
		WORKSHOP_VECTOR_INDEX: VectorizeIndex;
		AI: Ai;
		ASSETS: Fetcher;
