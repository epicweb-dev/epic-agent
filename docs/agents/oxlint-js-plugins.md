...
- Plugin name: `epic-agent-custom`
- Rule id: `no-example-identifier`
- Config key: `epic-agent-custom/no-example-identifier`
...
You should see a lint error from `epic-agent-custom/no-example-identifier`.
