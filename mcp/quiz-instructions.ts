...
const QUESTION_TYPES: QuizInstructionsResult['questionTypes'] = [
	{
		id: 'free-recall',
		label: 'Free recall',
		promptTemplate:
...
const QUIZ_CHECKLIST: QuizInstructionsResult['checklist'] = [
...
const QUIZ_CLOSING_STEPS: QuizInstructionsResult['closingSteps'] = [
...
export function buildQuizInstructionsResult(
	...
	return {
		...
		checklist: QUIZ_CHECKLIST,
		questionTypes: QUESTION_TYPES,
		closingSteps: QUIZ_CLOSING_STEPS,
	}
}
